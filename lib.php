...
class format_bootstraptabs extends format_base {
    ...
    public function get_section_name($section) {
        ...
        if ((string) $section->name !== '') {
            ...
            return get_string('section0name', 'format_bootstraptabs');
        } else {
    ...
    public function course_format_options($foreditform = false) {
        ...
        if ($courseformatoptions === false) {
            ...
            $courseformatoptions = array(
                ...
                'showGraphics' => array(
                    'label' => new lang_string('bootstraptabs_zero_as_tab', 'format_bootstraptabs'),
                    //'help' => 'bootstraptabs_zero_as_tab',
                ...
                'remember_last_tab_session' => array(
                    'label' => new lang_string('bootstraptabs_remember_last_tab_session', 'format_bootstraptabs'),
                    'help' => 'bootstraptabs_remember_last_tab_session',
     ...
     *
     * In case if course format was changed to 'bootstraptabs', we try to copy options
